            ...
            if (event.type == sf::Event::TextEntered)
            {
                ...
                if (event.text.unicode == 13)
                {
                    if (inputField.getString().getSize() > 0)
                    {
                        ...
                        {
                        case 0:
                           b = db.searchByTitle(str);
                            break;
                        case 1:
                            b = db.searchByAuthor(str);
                            break;
                        case 2:
                            b = db.searchByGenre(str);
                            break;
                        case 3:
                            b = db.searchByPublisher(str);
                            break;
                        }
                            int cnt = b.size();
                            string s[100];
